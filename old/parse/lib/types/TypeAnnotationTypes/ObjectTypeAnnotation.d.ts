...
export declare enum ObjectTypeElementKind {
...
export declare type ObjectTypeElement = ObjectTypeProperty | ObjectTypeIndexer | ObjectTypeSpreadProperty;
/**
 * Example:
 *
 *     type value = {x: number};
 */
export default interface ObjectTypeAnnotation extends TypeAnnotationBase {
    readonly kind: TypeAnnotationKind.ObjectTypeAnnotation;

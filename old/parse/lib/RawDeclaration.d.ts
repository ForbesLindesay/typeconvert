...
export declare type RawDeclaration = bt.FunctionDeclaration | bt.DeclareFunction | bt.InterfaceDeclaration | bt.DeclareInterface | bt.ClassDeclaration | bt.DeclareClass | bt.DeclareOpaqueType | bt.OpaqueType | bt.TypeAlias | bt.DeclareTypeAlias | bt.TSEnumDeclaration | bt.TSDeclareFunction | bt.TSTypeAliasDeclaration | bt.TSInterfaceDeclaration | ImportDefaultDeclaration | ImportNamedDeclaration | ImportNamespaceDeclaration | ImportCommonJSDeclaration | VariableDeclaration;
